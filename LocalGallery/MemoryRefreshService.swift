...
/// `GalleryManager` that owns memory state. Lets the BG handler call a stable
...
/// `GalleryManager.shared` weak-singleton pattern. The next foreground entry
/// runs the same generation via the foreground catch-up path.
@MainActor
final class MemoryRefreshService {
    private weak var manager: GalleryManager?

    func attach(_ manager: GalleryManager) {
