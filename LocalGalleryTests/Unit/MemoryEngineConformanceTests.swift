    ...
    private func scenarios() -> [ScenarioSpec] {
        ...
        out.append(ScenarioSpec(
            ...
            notes: [
                ...
                "…but the memory ID is formatted by an ISO8601DateFormatter whose time zone is GMT, so it says 2024-06-11. The id's date and the calendar day the memory is ABOUT are in different time zones. Pinned as-is; the port must reproduce it or every deep link and every seen-penalty key shifts by a day near midnight.",
            ],
            timeZone: "Asia/Tokyo",
